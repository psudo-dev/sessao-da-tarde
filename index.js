...
const options = {
    diasDaSemana: ["Nesta Segunda-Feira", "Nesta Terça-Feira", "Nesta Quarta-Feira", "Nesta Quinta-Feira", "Nesta Sexta-Feira"],
    atores: ["Steve Martin", "Chevy Chase", "Eddie Murphy", "Denny Devitto", "Bill Murray", "John Candy", "Tom Hanks", "Sylvester Stallone", "Arnold Schwarzenegger"],
    papel: [
    ...
    enredo: ["que é acusado injustamente por um crime que não cometeu", "que acaba de pintar na área", "que recebe um estranho presente", "que tem um talento muito especial"],
...
// takes an object with the options and return another with the choices
const randomizer = (optionsObject) => {
    ...
    return { // returning an object because it's easier to understand
...
const chamada = (selectedOptions) => { // text contructor
